{
	...
	//
	TFile *_file0 = TFile::Open("../../shapefileCombined_DATA_BDT_DilepCombined22ndJune2016_13TeVHadTop_JS.root");
	TH1F* nominal = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__nominal");
	//TH1F* MLM = (TH1F*)_file0->Get("comb4nJets__TTJets_MLM__nominal");
	//TH1F* FXFX = (TH1F*)_file0->Get("comb4nJets__TTJets_aMCatNLO__nominal");
	//TH1F* MLMorig = (TH1F*)_file0->Get("comb4nJets__TTJets_MLM__nominal");
	//TH1F* FXFXorig = (TH1F*)_file0->Get("comb4nJets__TTJets_aMCatNLO__nominal");

	TH1F* PUUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__PUUp");
	TH1F* PUDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__PUDown");
	TH1F* PUUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__PUUp");
	TH1F* PUDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__PUDown");

	TH1F* btag_lightDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_lightDown");
	TH1F* btag_lightUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_lightUp");
	TH1F* btag_lightDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_lightDown");
	TH1F* btag_lightUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_lightUp");

	TH1F* btag_heavyDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_heavyDown");
	TH1F* btag_heavyUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_heavyUp");
	TH1F* btag_heavyDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_heavyDown");
	TH1F* btag_heavyUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btag_heavyUp");

	TH1F* btag_CSVLFDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFDown");
	TH1F* btag_CSVLFUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFUp");
	TH1F* btag_CSVLFDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFDown");
	TH1F* btag_CSVLFUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFUp");

	TH1F* btag_CSVHFDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFDown");
	TH1F* btag_CSVHFUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFUp");
	TH1F* btag_CSVHFDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFDown");
	TH1F* btag_CSVHFUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFUp");

	TH1F* btag_CSVHFStats1Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats1Down");
	TH1F* btag_CSVHFStats1Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats1Up");
	TH1F* btag_CSVHFStats1DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats1Down");
	TH1F* btag_CSVHFStats1UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats1Up");

	TH1F* btag_CSVHFStats2Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats2Down");
	TH1F* btag_CSVHFStats2Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats2Up");
	TH1F* btag_CSVHFStats2DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats2Down");
	TH1F* btag_CSVHFStats2UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVHFStats2Up");

	TH1F* btag_CSVLFStats1Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats1Down");
	TH1F* btag_CSVLFStats1Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats1Up");
	TH1F* btag_CSVLFStats1DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats1Down");
	TH1F* btag_CSVLFStats1UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats1Up");

	TH1F* btag_CSVLFStats2Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats2Down");
	TH1F* btag_CSVLFStats2Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats2Up");
	TH1F* btag_CSVLFStats2DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats2Down");
	TH1F* btag_CSVLFStats2UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVLFStats2Up");

	TH1F* btag_CSVCFErr1Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr1Down");
	TH1F* btag_CSVCFErr1Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr1Up");
	TH1F* btag_CSVCFErr1DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr1Down");
	TH1F* btag_CSVCFErr1UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr1Up");

	TH1F* btag_CSVCFErr2Down = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr2Down");
	TH1F* btag_CSVCFErr2Up = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr2Up");
	TH1F* btag_CSVCFErr2DownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr2Down");
	TH1F* btag_CSVCFErr2UpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__btagWeightCSVCFErr2Up");

	TH1F* MEScaleDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttMEScaleDown");
	TH1F* MEScaleUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttMEScaleUp");
	TH1F* MEScaleDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttMEScaleDown");
	TH1F* MEScaleUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttMEScaleUp");

        TH1F* TTUEDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__TTUEDown");
        TH1F* TTUEUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__TTUEUp");
        TH1F* TTUEDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__TTUEDown");
        TH1F* TTUEUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__TTUEUp");

	TH1F* JESUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JESUp");
	TH1F* JESDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JESDown");
	TH1F* JESUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JESUp");
	TH1F* JESDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JESDown");

	TH1F* JERUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JERUp");
	TH1F* JERDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JERDown");
	TH1F* JERUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JERUp");
	TH1F* JERDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__JERDown"); 				

	TH1F* ttGeneratorUp = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttGeneratorUp");
	TH1F* ttGeneratorDown = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttGeneratorDown");
	TH1F* ttGeneratorUpOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttGeneratorUp");
	TH1F* ttGeneratorDownOrig = (TH1F*)_file0->Get("comb4nJets__ttbarTTX__ttGeneratorDown"); 	
...
//ttbar alternatives
	...
	TCanvas *cTTUE1 = new TCanvas();
	TPad *padTTUE1 = new TPad("pad1","pad1",0,0.3,1,1);
	cTTUE1->cd();
	padTTUE1->SetBottomMargin(0);
	padTTUE1->Draw();
	padTTUE1->cd();

	TTUEUp->SetLineColor(kRed);
	TTUEDown->SetLineColor(kCyan);

	TTUEUpOrig->SetLineColor(kRed);
	TTUEDownOrig->SetLineColor(kCyan);

	TTUEUp->SetLineStyle(1);
	TTUEDown->SetLineStyle(1);
	TTUEUpOrig->SetLineStyle(1);
	TTUEDownOrig->SetLineStyle(1);


	TTUEUp->SetLineWidth(2);
	TTUEDown->SetLineWidth(2);
	TTUEUpOrig->SetLineWidth(2);
	TTUEDownOrig->SetLineWidth(2);

	TTUEUpOrig->SetTitle("TTbar BDT disciminator");
	TTUEUpOrig->Draw("hist");
	TTUEDownOrig->Draw("histsame");
	nominal->Draw("histsame");
	TLegend *legTTUE = new TLegend(0.5,0.7,0.9,0.9);
	legTTUE->AddEntry(TTUEUp,"scaleH Up","l");
	legTTUE->AddEntry(nominal,"nominal ttbar","l");
	legTTUE->AddEntry(TTUEDown,"scaleH Down","l");
	legTTUE->Draw();
	cTTUE1->cd();

	TPad *pad2TTUE = new TPad("pad2","pad2",0,0,1,0.3);

	pad2TTUE->SetTopMargin(0);
	pad2TTUE->SetGridy();
	pad2TTUE->Draw();
	...
	// TTUEUp->Sumw2();
	TTUEUp->SetStats(0);
	TTUEUp->SetMinimum(0.5);
	TTUEUp->SetMaximum(1.5);
	TTUEUp->Divide(nominal);
	TTUEUp->SetMarkerStyle(1);
	TTUEUp->SetAxisRange(0,2,"Y");
	...
	// TTUEDown>Sumw2();
	TTUEDown->SetStats(0);
	TTUEDown->Divide(nominal);
	TTUEDown->SetMarkerStyle(1);
	TTUEDown->SetAxisRange(0,2,"Y");

	TTUEDown->Draw("epsame");
	cTTUE1->cd();
	cTTUE1->SaveAs("TTUEsystt.png");
